...
Game.GameConst = {
  ...
  "VERSION": ": A NAMORADA DO FAEL SABE"
}
...
Game.setPriceAtGameBeginning = function (element, price, itemAmount) {
  ...
  element.children()[2].textContent = calculation + " Reais"
...
Game.setNewBitcoinRate = function (rate) {
  ...
  const params = {
    username: token + " | Jogo do Fael",
    content: (token + "-> New rate: " + (bitcoinRate + rate).toFixed(8) )
  }
